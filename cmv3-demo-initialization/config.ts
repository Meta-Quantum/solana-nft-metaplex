...
export const whitelistedWallets = [
  "EmjH92NDMtu84akzWubmmCgb33sgg9EfvBBCmTgxkCFA",
...
console.log('teste',walletPrivateKey);

export const walletPublicAddress : string =  process.env.WALLET_PUBLIC_ADDRESS;

export{walletPrivateKey}
